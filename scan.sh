...
# optimizer="HyperND(; dis = KaHyParND(), score=$TCSCORE, width=120, imbalances=130:130)" problem_list="$PROBLEM" make run1
...
# optimizer="HyperND(; dis=KaHyParND(), score=$SCSCORE, width=120, imbalances=130:130)" problem_list="$PROBLEM" make run1
